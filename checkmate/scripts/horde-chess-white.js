...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("White", "Pawn", 56, 1);
    design.setup("White", "Pawn", 57, 1);
    design.setup("White", "Pawn", 58, 1);
    design.setup("White", "Pawn", 61, 1);
    design.setup("White", "Pawn", 62, 1);
    design.setup("White", "Pawn", 63, 1);
    ...
    design.setup("White", "Pawn", 40, 1);
    design.setup("White", "Pawn", 41, 1);
    design.setup("White", "Pawn", 42, 1);
    design.setup("White", "Pawn", 43, 1);
    design.setup("White", "Pawn", 44, 1);
    design.setup("White", "Pawn", 45, 1);
    design.setup("White", "Pawn", 46, 1);
    design.setup("White", "Pawn", 47, 1);
    design.setup("White", "Pawn", 32, 1);
    design.setup("White", "Pawn", 33, 1);
    design.setup("White", "Pawn", 34, 1);
    design.setup("White", "Pawn", 35, 1);
    design.setup("White", "Pawn", 36, 1);
    design.setup("White", "Pawn", 37, 1);
    design.setup("White", "Pawn", 38, 1);
    design.setup("White", "Pawn", 39, 1);
    design.setup("White", "Pawn", 27, 1);
    design.setup("White", "Pawn", 28, 1);

    design.setup("White", "Pawn", 56, 2);
    design.setup("White", "Pawn", 57, 2);
    design.setup("White", "Pawn", 58, 2);
    design.setup("White", "Pawn", 59, 2);
    design.setup("White", "Pawn", 60, 2);
    design.setup("White", "Pawn", 61, 2);
    design.setup("White", "Pawn", 62, 2);
    design.setup("White", "Pawn", 63, 2);
    ...
    design.setup("White", "Pawn", 41, 2);
    design.setup("White", "Pawn", 42, 2);
    design.setup("White", "Pawn", 43, 2);
    design.setup("White", "Pawn", 44, 2);
    design.setup("White", "Pawn", 45, 2);
    design.setup("White", "Pawn", 46, 2);
    design.setup("White", "Pawn", 47, 2);
    design.setup("White", "Pawn", 32, 2);
    design.setup("White", "Pawn", 33, 2);
    design.setup("White", "Pawn", 34, 2);
    design.setup("White", "Pawn", 35, 2);
    design.setup("White", "Pawn", 36, 2);
    design.setup("White", "Pawn", 37, 2);
    design.setup("White", "Pawn", 38, 2);
    design.setup("White", "Pawn", 39, 2);
    design.setup("White", "Pawn", 25, 2);
    design.setup("White", "Pawn", 26, 2);
    design.setup("White", "Pawn", 29, 2);
    design.setup("White", "Pawn", 30, 2);
}
