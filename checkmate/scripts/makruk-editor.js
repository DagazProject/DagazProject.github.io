...
Dagaz.View.configure = function(view) {
    view.defBoard("Board");
    view.defPiece("WhiteKhun", "You WhiteKhun");
    view.defPiece("BlackKhun", "You BlackKhun");
    view.defPiece("WhiteMet", "You WhiteMet");
    view.defPiece("BlackMet", "You BlackMet");
    view.defPiece("WhiteRuea", "You WhiteRuea");
    view.defPiece("BlackRuea", "You BlackRuea");
    view.defPiece("WhiteKhon", "You WhiteKhon");
    view.defPiece("BlackKhon", "You BlackKhon");
    view.defPiece("WhiteMa", "You WhiteMa");
    view.defPiece("BlackMa", "You BlackMa");
    view.defPiece("WhiteBia", "You WhiteBia");
    view.defPiece("BlackBia", "You BlackBia");
