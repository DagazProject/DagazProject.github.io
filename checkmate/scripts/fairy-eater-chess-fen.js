...
var createPiece = function(design, c) {
  ...
  if (c == 'S') return Dagaz.Model.createPiece(design.getPieceType("Shield"), 1);
  if (c == 's') return Dagaz.Model.createPiece(design.getPieceType("Shield"), 2);
  if (c == 'G') return Dagaz.Model.createPiece(design.getPieceType("Ghost"), 1);
  if (c == 'g') return Dagaz.Model.createPiece(design.getPieceType("Ghost"), 2);
  if (c == 'H') return Dagaz.Model.createPiece(design.getPieceType("Chaos"), 1);
  if (c == 'h') return Dagaz.Model.createPiece(design.getPieceType("Chaos"), 2);
  if (c == 'R') return Dagaz.Model.createPiece(design.getPieceType("Reaper"), 1);
  if (c == 'r') return Dagaz.Model.createPiece(design.getPieceType("Reaper"), 2);
  if (c == 'N') return Dagaz.Model.createPiece(design.getPieceType("Knightrider"), 1);
  if (c == 'n') return Dagaz.Model.createPiece(design.getPieceType("Knightrider"), 2);
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Shield"))      r = 'S';
  if (piece.type == design.getPieceType("Ghost"))       r = 'G';
  if (piece.type == design.getPieceType("Chaos"))       r = 'H';
  if (piece.type == design.getPieceType("Reaper"))      r = 'R';
  if (piece.type == design.getPieceType("Knightrider")) r = 'N';
