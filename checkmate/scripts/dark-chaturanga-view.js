...
Dagaz.Model.Done = function(design, board) {
  ...
  _.each(design.allPositions(), function(pos) {
      ...
      if (piece !== null) {
          ...
          if (piece.type == 3) {
              checkJump(design, board, piece.player, pos, nw, nw, visible);
              checkJump(design, board, piece.player, pos, ne, ne, visible);
              checkJump(design, board, piece.player, pos, sw, sw, visible);
              checkJump(design, board, piece.player, pos, se, se, visible);
          }
          if (piece.type == 4) {
