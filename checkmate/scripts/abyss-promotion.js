  ...
  _.each(board.moves, function(move) {
      if (move.isSimpleMove()) {
          ...
          if ((piece !== null) && (piece.type == pawn) && 
              ...
              pieces.push(piece.promote(design.getPieceType("BishopK")));
              pieces.push(piece.promote(design.getPieceType("Knight")));
              pieces.push(piece.promote(design.getPieceType("KnightK")));
              pieces.push(piece.promote(design.getPieceType("Rook")));
              pieces.push(piece.promote(design.getPieceType("RookK")));
              pieces.push(piece.promote(design.getPieceType("Queen")));
              pieces.push(piece.promote(design.getPieceType("Angel")));
