...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPiece("Bomb", 2, 0);
    design.addMove(2, 1, [0, 9], 0);
    design.addMove(2, 1, [1, 9], 0);
    design.addMove(2, 1, [2, 9], 0);
...
Dagaz.View.configure = function(view) {
    ...
    view.defControl("ResControl", "3D", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'platform-bomb.htm' : 'platform-bomb-board.htm');
    view.defControl(Dagaz.AI.ON ? "AiOnControl" : "AiOffControl", Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'platform-bomb-3d-board.htm' : 'platform-bomb-3d.htm');
    view.defControl(Dagaz.Controller.soundOff ? ["SoundOffControl", "SoundOnControl"] : ["SoundOnControl", "SoundOffControl"], "Sound", true, Dagaz.Controller.switchSound);
    view.defControl("RedoControl", "Redo Move", false, Dagaz.Controller.redo);

    view.defSubMenu(5, "Promote");
    view.defSubMenuControl(5, "WKnight", "Knight", true, Dagaz.Controller.menuItem, 4);
    view.defSubMenuControl(5, "WBishop", "Bishop", true, Dagaz.Controller.menuItem, 5);
    view.defSubMenuControl(5, "WRook",   "Rook", true, Dagaz.Controller.menuItem, 3);
    view.defSubMenuControl(5, "WQueen",  "Queen", true, Dagaz.Controller.menuItem, 6);
    view.defSubMenuControl(5, "WBomb",  "Bomb", true, Dagaz.Controller.menuItem, 2);
 
    view.defSubMenu(15, "Promote");
    view.defSubMenuControl(15, "BKnight", "Knight", true, Dagaz.Controller.menuItem, 4);
    view.defSubMenuControl(15, "BBishop", "Bishop", true, Dagaz.Controller.menuItem, 5);
    view.defSubMenuControl(15, "BRook",   "Rook", true, Dagaz.Controller.menuItem, 3);
    view.defSubMenuControl(15, "BQueen",  "Queen", true, Dagaz.Controller.menuItem, 6);
    view.defSubMenuControl(15, "BBomb",  "Bomb", true, Dagaz.Controller.menuItem, 2);
