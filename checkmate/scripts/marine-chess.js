...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(0, 3, [3, 7, 7, 3, 7], 0);
    design.addMove(0, 3, [4, 7, 7, 4, 7], 0);

    design.addPiece("Rook", 1, 500);
    design.addMove(1, 4, [7, 7, 7], 0);
    design.addMove(1, 4, [1, 1, 1], 0);
    design.addMove(1, 4, [4, 4, 4], 0);
    design.addMove(1, 4, [3, 3, 3], 0);

    design.addPiece("Knight", 2, 320);
    design.addMove(2, 5, [7, 6, 7, 6], 0);
    design.addMove(2, 5, [7, 5, 7, 5], 0);
    design.addMove(2, 5, [1, 2, 1, 2], 0);
    design.addMove(2, 5, [1, 0, 1, 0], 0);
    design.addMove(2, 5, [4, 6, 4, 6], 0);
    design.addMove(2, 5, [4, 2, 4, 2], 0);
    design.addMove(2, 5, [3, 5, 3, 5], 0);
    design.addMove(2, 5, [3, 0, 3, 0], 0);

    design.addPiece("Bishop", 3, 330);
    design.addMove(3, 4, [6, 6, 6], 0);
    design.addMove(3, 4, [2, 2, 2], 0);
    design.addMove(3, 4, [5, 5, 5], 0);
    design.addMove(3, 4, [0, 0, 0], 0);

    design.addPiece("Queen", 4, 900);
    design.addMove(4, 4, [7, 7, 7], 0);
    design.addMove(4, 4, [1, 1, 1], 0);
    design.addMove(4, 4, [4, 4, 4], 0);
    design.addMove(4, 4, [3, 3, 3], 0);
    design.addMove(4, 4, [6, 6, 6], 0);
    design.addMove(4, 4, [2, 2, 2], 0);
    design.addMove(4, 4, [5, 5, 5], 0);
    design.addMove(4, 4, [0, 0, 0], 0);
