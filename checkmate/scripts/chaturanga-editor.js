...
Dagaz.View.configure = function(view) {
    view.defBoard("Board");
    view.defPiece("WhiteRaja", "You WhiteRaja");
    view.defPiece("BlackRaja", "You BlackRaja");
    view.defPiece("WhiteMantri", "You WhiteMantri");
    view.defPiece("BlackMantri", "You BlackMantri");
    view.defPiece("WhiteRatha", "You WhiteRatha");
    view.defPiece("BlackRatha", "You BlackRatha");
    view.defPiece("WhiteGaja", "You WhiteGaja");
    view.defPiece("BlackGaja", "You BlackGaja");
    view.defPiece("WhiteAshva", "You WhiteAshva");
    view.defPiece("BlackAshva", "You BlackAshva");
    view.defPiece("WhiteBhata", "You WhiteBhata");
    view.defPiece("BlackBhata", "You BlackBhata");
