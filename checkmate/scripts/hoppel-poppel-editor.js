...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("WhiteKnibis", "You WhiteKnibis");
    view.defPiece("BlackKnibis", "You BlackKnibis");
    view.defPiece("WhiteBiskni", "You WhiteBiskni");
    view.defPiece("BlackBiskni", "You BlackBiskni");
