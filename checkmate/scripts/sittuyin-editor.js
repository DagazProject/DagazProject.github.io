...
Dagaz.Model.TO_CHAR = 'KkQqRrBbNnPp';
...
Dagaz.Model.checkTurn = function(turn, url) {
  ...
  if (result) {
      if (_.indexOf([8, 9, 10, 11, 12, 13, 14, 15, 17], +turn) >= 0) return 17;
          else return 16;
  } else {
      if (turn == 9) return 9;
          else return 8;
...
Dagaz.View.configure = function(view) {
    view.defBoard("Board");
    view.defPiece("WhiteMin-gyi", "You WhiteMin-gyi");
    view.defPiece("BlackMin-gyi", "You BlackMin-gyi");
    view.defPiece("WhiteSit-ke", "You WhiteSit-ke");
    view.defPiece("BlackSit-ke", "You BlackSit-ke");
    view.defPiece("WhiteYahhta", "You WhiteYahhta");
    view.defPiece("BlackYahhta", "You BlackYahhta");
    view.defPiece("WhiteSin", "You WhiteSin");
    view.defPiece("BlackSin", "You BlackSin");
    view.defPiece("WhiteMyin", "You WhiteMyin");
    view.defPiece("BlackMyin", "You BlackMyin");
    view.defPiece("WhiteNe", "You WhiteNe");
    view.defPiece("BlackNe", "You BlackNe");
