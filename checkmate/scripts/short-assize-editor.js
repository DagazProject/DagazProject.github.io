...
Dagaz.Model.checkTurn = function(turn, url) {
  ...
  if (result) {
      if (_.indexOf([7, 8, 9, 10, 11, 12, 13, 15], +turn) >= 0) return 15;
          else return 14;
  } else {
      if (turn == 8) return 8;
          else return 7;
...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPiece("WhitePQ", 12);
    design.addDrop(12, 0, [], 0);
    design.addMove(12, 1, [], 0);

    design.addPiece("BlackPQ", 13);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("WhitePQ", "You WhitePQ");
    view.defPiece("BlackPQ", "You BlackPQ");
