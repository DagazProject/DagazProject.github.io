...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("A7", 20, 0, 67, 67);
    view.defPosition("B7", 87, 0, 67, 67);
    view.defPosition("C7", 154, 0, 67, 67);
    view.defPosition("D7", 221, 0, 67, 67);
    view.defPosition("E7", 288, 0, 67, 67);
    view.defPosition("F7", 355, 0, 67, 67);
    view.defPosition("G7", 422, 0, 67, 67);
    view.defPosition("A6", 20, 67, 67, 67);
    view.defPosition("B6", 87, 67, 67, 67);
    view.defPosition("C6", 154, 67, 67, 67);
    view.defPosition("D6", 221, 67, 67, 67);
    view.defPosition("E6", 288, 67, 67, 67);
    view.defPosition("F6", 355, 67, 67, 67);
    view.defPosition("G6", 422, 67, 67, 67);
    view.defPosition("A5", 20, 134, 67, 67);
    view.defPosition("B5", 87, 134, 67, 67);
    view.defPosition("C5", 154, 134, 67, 67);
    view.defPosition("D5", 221, 134, 67, 67);
    view.defPosition("E5", 288, 134, 67, 67);
    view.defPosition("F5", 355, 134, 67, 67);
    view.defPosition("G5", 422, 134, 67, 67);
    view.defPosition("A4", 20, 201, 67, 67);
    view.defPosition("B4", 87, 201, 67, 67);
    view.defPosition("C4", 154, 201, 67, 67);
    view.defPosition("D4", 221, 201, 67, 67);
    view.defPosition("E4", 288, 201, 67, 67);
    view.defPosition("F4", 355, 201, 67, 67);
    view.defPosition("G4", 422, 201, 67, 67);
    view.defPosition("A3", 20, 268, 67, 67);
    view.defPosition("B3", 87, 268, 67, 67);
    view.defPosition("C3", 154, 268, 67, 67);
    view.defPosition("D3", 221, 268, 67, 67);
    view.defPosition("E3", 288, 268, 67, 67);
    view.defPosition("F3", 355, 268, 67, 67);
    view.defPosition("G3", 422, 268, 67, 67);
    view.defPosition("A2", 20, 335, 67, 67);
    view.defPosition("B2", 87, 335, 67, 67);
    view.defPosition("C2", 154, 335, 67, 67);
    view.defPosition("D2", 221, 335, 67, 67);
    view.defPosition("E2", 288, 335, 67, 67);
    view.defPosition("F2", 355, 335, 67, 67);
    view.defPosition("G2", 422, 335, 67, 67);
    view.defPosition("A1", 20, 402, 67, 67);
    view.defPosition("B1", 87, 402, 67, 67);
    view.defPosition("C1", 154, 402, 67, 67);
    view.defPosition("D1", 221, 402, 67, 67);
    view.defPosition("E1", 288, 402, 67, 67);
    view.defPosition("F1", 355, 402, 67, 67);
    view.defPosition("G1", 422, 402, 67, 67);
    view.defPosition("a7", 20, 0, 67, 67);
    view.defPosition("b7", 87, 0, 67, 67);
    view.defPosition("c7", 154, 0, 67, 67);
    view.defPosition("d7", 221, 0, 67, 67);
    ...
    view.defPosition("f1", 355, 402, 67, 67);
    view.defPosition("g1", 422, 402, 67, 67);
    view.defPosition("P1", 490, 452, 16, 16);
    view.defPosition("P1", 1, 1, 16, 16);

    view.defPopup("Promote", 179, 100);
