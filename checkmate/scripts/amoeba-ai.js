...
Dagaz.AI.g_flags = moveflagPromotion | moveflagPromoteKnight;
...
Dagaz.AI.isNoZugzwang = function() {
    return Dagaz.AI.g_pieceCount[pieceKnight | Dagaz.AI.g_toMove] != 0 ||
...
Dagaz.AI.ResetGame = function() {
  ...
  pieceSquareAdj[pieceHole]   = MakeTable(Dagaz.AI.pieceAdj[pieceEmpty]);
