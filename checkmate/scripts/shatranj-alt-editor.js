...
Dagaz.View.configure = function(view) {
    view.defBoard("Board");
    view.defPiece("WhiteShah", "You WhiteShah");
    view.defPiece("BlackShah", "You BlackShah");
    view.defPiece("WhiteFers", "You WhiteFers");
    view.defPiece("BlackFers", "You BlackFers");
    view.defPiece("WhiteRokh", "You WhiteRokh");
    view.defPiece("BlackRokh", "You BlackRokh");
    view.defPiece("WhiteAlfil", "You WhiteAlfil");
    view.defPiece("BlackAlfil", "You BlackAlfil");
    view.defPiece("WhiteAsb", "You WhiteAsb");
    view.defPiece("BlackAsb", "You BlackAsb");
    view.defPiece("WhiteSarbaz", "You WhiteSarbaz");
    view.defPiece("BlackSarbaz", "You BlackSarbaz");
