...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addTurn(1, [1, 2, 3, 4, 5, 6]); // 0
    design.addTurn(1, [1, 2, 3, 4, 5, 6]); // 1
    design.addTurn(2, [1, 2, 3, 4, 5, 6]); // 2
    design.addTurn(2, [1, 2, 3, 4, 5, 6]); // 3
    design.addTurn(3, [1, 2, 3, 4, 5, 6]); // 4
    design.addTurn(3, [1, 2, 3, 4, 5, 6]); // 5
    design.addTurn(4, [1, 2, 3, 4, 5, 6]); // 6
    design.addTurn(4, [1, 2, 3, 4, 5, 6]); // 7
...
Dagaz.View.configure = function(view) {
    view.defBoard("SBoard", 0, 0, undefined, [0, 1]);
    view.defBoard("WBoard", 0, 0, undefined, [2, 3]);
    view.defBoard("NBoard", 0, 0, undefined, [4, 5]);
    view.defBoard("EBoard", 0, 0, undefined, [6, 7]);
