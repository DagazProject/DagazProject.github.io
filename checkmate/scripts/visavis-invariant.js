...
Dagaz.Model.checkPositions = function(design, board, player, positions) {
  ...
  for (var i = 0; i < positions.length; i++) {
       ...
       if (checkDirection(design, board, player, pos, nw, [pawn], [bishop, queen])) return true;
       if (checkDirection(design, board, player, pos, ne, [pawn], [bishop, queen])) return true;
