...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addCommand(1, ZRF.MODE,	2);	// cont-type
    design.addCommand(1, ZRF.FUNCTION,	25);	// to
    design.addCommand(1, ZRF.FUNCTION,	28);	// end
    design.addCommand(1, ZRF.PARAM,	4);	// $5
    design.addCommand(1, ZRF.FUNCTION,	22);	// navigate
    design.addCommand(1, ZRF.JUMP,	-19);
    design.addCommand(1, ZRF.FUNCTION,	28);	// end
    ...
    design.addPiece("Init", 0);
    design.addMove(0, 0, [], 0);

    design.addPiece("Man", 1);
    design.addMove(1, 1, [5, 5, 5, 5, 5], 2);
    design.addMove(1, 1, [4, 4, 4, 4, 4], 2);
    design.addMove(1, 1, [3, 3, 3, 3, 3], 2);
    design.addMove(1, 1, [1, 1, 1, 1, 1], 2);
    design.addMove(1, 1, [2, 2, 2, 2, 2], 2);
    design.addMove(1, 1, [0, 0, 0, 0, 0], 2);
    ...
    design.setup("Gold", "Init", 6);
    design.setup("Gold", "Init", 30);
    design.setup("Gold", "Init", 72);
    design.setup("Gold", "Init", 46);
    design.setup("Gold", "Init", 38);
    design.setup("Gold", "Init", 25);
    design.setup("Gold", "Init", 69);
    design.setup("Gold", "Init", 37);
    design.setup("Gold", "Init", 29);
    design.setup("Gold", "Init", 39);
    design.setup("Gold", "Init", 82);
    design.setup("Gold", "Init", 47);
    design.setup("Gold", "Init", 21);
    design.setup("Gold", "Init", 28);
    design.setup("Gold", "Init", 8);
    design.setup("Gold", "Init", 16);
    design.setup("Gold", "Init", 19);
    design.setup("Gold", "Init", 74);
    design.setup("Gold", "Init", 53);
    design.setup("Gold", "Init", 79);
    design.setup("Gold", "Init", 102);
    design.setup("Gold", "Init", 62);
    design.setup("Gold", "Init", 67);
    design.setup("Gold", "Init", 35);
    design.setup("Gold", "Init", 7);
    design.setup("Gold", "Init", 27);
    design.setup("Gold", "Init", 31);
    design.setup("Gold", "Init", 93);
    design.setup("Gold", "Init", 15);
    design.setup("Gold", "Init", 91);
    design.setup("Gold", "Init", 89);
    design.setup("Gold", "Init", 66);
    design.setup("Gold", "Init", 100);
    design.setup("Gold", "Init", 81);
    design.setup("Gold", "Init", 42);
    design.setup("Gold", "Init", 95);
    design.setup("Gold", "Init", 99);
    design.setup("Gold", "Init", 113);
    design.setup("Gold", "Init", 111);
    design.setup("Gold", "Init", 94);
    design.setup("Gold", "Init", 75);
    design.setup("Gold", "Init", 105);
    design.setup("Silver", "Init", 92);
    design.setup("Silver", "Init", 68);
    design.setup("Silver", "Init", 18);
    design.setup("Silver", "Init", 49);
    design.setup("Silver", "Init", 90);
    design.setup("Silver", "Init", 56);
    design.setup("Silver", "Init", 61);
    design.setup("Silver", "Init", 70);
    design.setup("Silver", "Init", 50);
    design.setup("Silver", "Init", 48);
    design.setup("Silver", "Init", 41);
    design.setup("Silver", "Init", 43);
    design.setup("Silver", "Init", 17);
    design.setup("Silver", "Init", 59);
    design.setup("Silver", "Init", 9);
    design.setup("Silver", "Init", 83);
    design.setup("Silver", "Init", 58);
    design.setup("Silver", "Init", 78);
    design.setup("Silver", "Init", 71);
    design.setup("Silver", "Init", 20);
    design.setup("Silver", "Init", 103);
    design.setup("Silver", "Init", 51);
    design.setup("Silver", "Init", 57);
    design.setup("Silver", "Init", 64);
    design.setup("Silver", "Init", 36);
    design.setup("Silver", "Init", 63);
    design.setup("Silver", "Init", 52);
    design.setup("Silver", "Init", 26);
    design.setup("Silver", "Init", 40);
    design.setup("Silver", "Init", 80);
    design.setup("Silver", "Init", 88);
    design.setup("Silver", "Init", 32);
    design.setup("Silver", "Init", 45);
    design.setup("Silver", "Init", 73);
    design.setup("Silver", "Init", 54);
    design.setup("Silver", "Init", 101);
    design.setup("Silver", "Init", 77);
    design.setup("Silver", "Init", 112);
    design.setup("Silver", "Init", 114);
    design.setup("Silver", "Init", 104);
    design.setup("Silver", "Init", 84);
    design.setup("Silver", "Init", 85);
}
