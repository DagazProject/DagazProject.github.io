...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addTurn(1, [1, 2, 3, 4, 5, 6]); // 4 -> 3
    design.addTurn(1, [1, 2, 3, 4, 5, 6]); // 5 -> 4
    design.addTurn(1, [1, 2, 3, 4, 5, 6]); // 6 -> 5
    design.addRandom(2, [0]); // 8 -> 6
    design.addRandom(2, [0]); // 9 -> 7
    design.addRandom(2, [0]); // 8
    design.addTurn(2, [1, 2, 3, 4, 5, 6]); // 10 -> 9
    design.addTurn(2, [1, 2, 3, 4, 5, 6]); // 11 -> 10
    design.addTurn(2, [1, 2, 3, 4, 5, 6]); // 12 -> 11
