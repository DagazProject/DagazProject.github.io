...
Dagaz.View.configure = function(view) {
    ...
    view.defControl("ResControl", "3D", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'dodgem-8x8.htm' : 'dodgem-8x8-board.htm');
    view.defControl(Dagaz.AI.ON ? "AiOnControl" : "AiOffControl", Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'dodgem-8x8-3d-board.htm' : 'dodgem-8x8-3d.htm');
    view.defControl(Dagaz.Controller.soundOff ? ["SoundOffControl", "SoundOnControl"] : ["SoundOnControl", "SoundOffControl"], "Sound", true, Dagaz.Controller.switchSound);
    view.defControl("RedoControl", "Redo Move", false, Dagaz.Controller.redo);

    view.defPosition("a8", -217, -217, 60, 60, 0);
    view.defPosition("b8", -155, -217, 60, 60, 0);
    view.defPosition("c8", -93, -217, 60, 60, 0);
    view.defPosition("d8", -31, -217, 60, 60, 0);
    view.defPosition("e8", 31, -217, 60, 60, 0);
    view.defPosition("f8", 93, -217, 60, 60, 0);
    view.defPosition("g8", 155, -217, 60, 60, 0);
    view.defPosition("h8", 217, -217, 60, 60, 0);
    view.defPosition("a7", -217, -155, 60, 60, 0);
    view.defPosition("b7", -155, -155, 60, 60, 0);
    view.defPosition("c7", -93, -155, 60, 60, 0);
    view.defPosition("d7", -31, -155, 60, 60, 0);
    view.defPosition("e7", 31, -155, 60, 60, 0);
    view.defPosition("f7", 93, -155, 60, 60, 0);
    view.defPosition("g7", 155, -155, 60, 60, 0);
    view.defPosition("h7", 217, -155, 60, 60, 0);
    view.defPosition("a6", -217, -93, 60, 60, 0);
    view.defPosition("b6", -155, -93, 60, 60, 0);
    view.defPosition("c6", -93, -93, 60, 60, 0);
    view.defPosition("d6", -31, -93, 60, 60, 0);
    view.defPosition("e6", 31, -93, 60, 60, 0);
    view.defPosition("f6", 93, -93, 60, 60, 0);
    view.defPosition("g6", 155, -93, 60, 60, 0);
    view.defPosition("h6", 217, -93, 60, 60, 0);
    view.defPosition("a5", -217, -31, 60, 60, 0);
    view.defPosition("b5", -155, -31, 60, 60, 0);
    view.defPosition("c5", -93, -31, 60, 60, 0);
    view.defPosition("d5", -31, -31, 60, 60, 0);
    view.defPosition("e5", 31, -31, 60, 60, 0);
    view.defPosition("f5", 93, -31, 60, 60, 0);
    view.defPosition("g5", 155, -31, 60, 60, 0);
    view.defPosition("h5", 217, -31, 60, 60, 0);
    view.defPosition("a4", -217, 31, 60, 60, 0);
    view.defPosition("b4", -155, 31, 60, 60, 0);
    view.defPosition("c4", -93, 31, 60, 60, 0);
    view.defPosition("d4", -31, 31, 60, 60, 0);
    view.defPosition("e4", 31, 31, 60, 60, 0);
    view.defPosition("f4", 93, 31, 60, 60, 0);
    view.defPosition("g4", 155, 31, 60, 60, 0);
    view.defPosition("h4", 217, 31, 60, 60, 0);
    view.defPosition("a3", -217, 93, 60, 60, 0);
    view.defPosition("b3", -155, 93, 60, 60, 0);
    view.defPosition("c3", -93, 93, 60, 60, 0);
    view.defPosition("d3", -31, 93, 60, 60, 0);
    view.defPosition("e3", 31, 93, 60, 60, 0);
    view.defPosition("f3", 93, 93, 60, 60, 0);
    view.defPosition("g3", 155, 93, 60, 60, 0);
    view.defPosition("h3", 217, 93, 60, 60, 0);
    view.defPosition("a2", -217, 155, 60, 60, 0);
    view.defPosition("b2", -155, 155, 60, 60, 0);
    view.defPosition("c2", -93, 155, 60, 60, 0);
    view.defPosition("d2", -31, 155, 60, 60, 0);
    view.defPosition("e2", 31, 155, 60, 60, 0);
    view.defPosition("f2", 93, 155, 60, 60, 0);
    view.defPosition("g2", 155, 155, 60, 60, 0);
    view.defPosition("h2", 217, 155, 60, 60, 0);
    view.defPosition("a1", -217, 217, 60, 60, 0);
    view.defPosition("b1", -155, 217, 60, 60, 0);
    view.defPosition("c1", -93, 217, 60, 60, 0);
    view.defPosition("d1", -31, 217, 60, 60, 0);
    view.defPosition("e1", 31, 217, 60, 60, 0);
    view.defPosition("f1", 93, 217, 60, 60, 0);
    view.defPosition("g1", 155, 217, 60, 60, 0);
    view.defPosition("h1", 217, 217, 60, 60, 0);
}
