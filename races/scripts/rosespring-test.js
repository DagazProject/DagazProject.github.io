...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.repeatMark();
    design.addRandom(1, [0]); // 2 -> 0 -> 2
    design.addRandom(1, [0]); // 3 -> 1 -> 3
    design.addRandom(1, [0]); // 2 -> 4
    design.addTurn(1, [1, 2, 3, 4, 5, 6]); // 4 -> 3 -> 5
    design.addTurn(1, [1, 2, 3, 4, 5, 6]); // 5 -> 4 -> 6
    design.addTurn(1, [1, 2, 3, 4, 5, 6]); // 6 -> 5 -> 7
    design.addRandom(2, [0]); // 8 -> 6 -> 8
    design.addRandom(2, [0]); // 9 -> 7 -> 9
    design.addRandom(2, [0]); // 8 -> 10
    design.addTurn(2, [1, 2, 3, 4, 5, 6]); // 10 -> 9  -> 11
    design.addTurn(2, [1, 2, 3, 4, 5, 6]); // 11 -> 10 -> 12
    design.addTurn(2, [1, 2, 3, 4, 5, 6]); // 12 -> 11 -> 13
    ...
    design.addZone("init-zone", 1, [447]);
    design.addZone("init-zone", 2, [444]);
