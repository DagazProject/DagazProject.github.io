...
Dagaz.View.configure = function(view) {
    ...
    view.defControl("ResControl", "3D", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'dodgem-7x7.htm' : 'dodgem-7x7-board.htm');
    view.defControl(Dagaz.AI.ON ? "AiOnControl" : "AiOffControl", Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'dodgem-7x7-3d-board.htm' : 'dodgem-7x7-3d.htm');
