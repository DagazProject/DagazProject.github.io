...
//  design.checkVersion("advisor-wait", "25");
    ...
    design.setup("White", "Man", 56, undefined, '0');
    design.setup("White", "Man", 58, undefined, '0');
    design.setup("White", "Man", 60, undefined, '0');
    design.setup("White", "Man", 62, undefined, '0');
    design.setup("White", "Man", 49, undefined, '0');
    design.setup("White", "Man", 51, undefined, '0');
    design.setup("White", "Man", 53, undefined, '0');
    design.setup("White", "Man", 55, undefined, '0');
    design.setup("Black", "Man", 8, undefined, '1');
    design.setup("Black", "Man", 10, undefined, '1');
    design.setup("Black", "Man", 12, undefined, '1');
    design.setup("Black", "Man", 14, undefined, '1');
    design.setup("Black", "Man", 1, undefined, '1');
    design.setup("Black", "Man", 3, undefined, '1');
    design.setup("Black", "Man", 5, undefined, '1');
    design.setup("Black", "Man", 7, undefined, '1');
}
