...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPosition("a4", [6, 5, 0, 1, 0, 0, 0, 0]);
    design.addPosition("b4", [6, 5, 4, 1, -1, 0, 0, 0]);
    design.addPosition("c4", [6, 5, 4, 1, -1, 0, 0, 0]);
    design.addPosition("d4", [6, 5, 4, 1, -1, 0, 0, 0]);
    design.addPosition("e4", [0, 5, 4, 0, -1, 0, 0, 0]);
    ...
    design.addZone("last-rank", 2, [15, 16, 17, 18, 19]);
...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("e4", 274, 2, 68, 68);
    ...
    view.defPosition("e3", 274, 70, 68, 68);
    ...
    view.defPosition("e2", 274, 138, 68, 68);
    ...
    view.defPosition("e1", 274, 206, 68, 68);
}
