...
Dagaz.View.configure = function(view) {
    ...
    view.defControl("ResControl", "3D", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'gauntlet-5x5.htm' : 'gauntlet-5x5-board.htm');
    view.defControl(Dagaz.AI.ON ? "AiOnControl" : "AiOffControl", Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'gauntlet-5x5-3d-board.htm' : 'gauntlet-5x5-3d.htm');
