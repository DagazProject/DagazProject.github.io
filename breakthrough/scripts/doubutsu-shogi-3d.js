...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("b4", 0, -141, 103, 93, 1);
    view.defPosition("c4", 93, -141, 103, 93, 1);
    view.defPosition("g4", 186, -141, 103, 93, 1);
    view.defPosition("r3", -186, -47, 103, 93, 1);
    view.defPosition("a3", -93, -47, 103, 93, 1);
    view.defPosition("b3", 0, -47, 103, 93, 1);
    view.defPosition("c3", 93, -47, 103, 93, 1);
    view.defPosition("g3", 186, -47, 103, 93, 1);
    view.defPosition("r2", -186, 47, 103, 93, 1);
    view.defPosition("a2", -93, 47, 103, 93, 1);
    view.defPosition("b2", 0, 47, 103, 93, 1);
    view.defPosition("c2", 93, 47, 103, 93, 1);
    view.defPosition("g2", 186, 47, 103, 93, 1);
    view.defPosition("r1", -186, 141, 103, 93, 1);
    view.defPosition("a1", -93, 141, 103, 93, 1);
    view.defPosition("b1", 0, 141, 103, 93, 1);
    view.defPosition("c1", 93, 141, 103, 93, 1);
    view.defPosition("g1", 186, 141, 103, 93, 1);
}
