...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("You", "WRBGOY", p('c2'), undefined, 4);
    design.setup("You", "WRBGOY", p('c3'), undefined, 4);
    design.setup("You", "WRBGOY", p('d1'), undefined, 10);
    ...
    design.setup("You", "WRBGOY", p('f1'), undefined, 2);
    design.setup("You", "WRBGOY", p('f2'), undefined, 5);
    design.setup("You", "WRBGOY", p('f3'), undefined, 5);
    design.setup("You", "WRBGOY", p('g1'), undefined, 8);
    design.setup("You", "WRBGOY", p('g2'), undefined, 8);
    design.setup("You", "WRBGOY", p('g3'), undefined, 11);
    ...
    design.setup("You", "WRBGOY", p('i3'), undefined, 6);
}
