...
Dagaz.View.configure = function(view) {
    ...
    view.defControl(Dagaz.AI.ON ? "AiOnControl" : "AiOffControl", Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'xiangqi-3d-western-board.htm' : 'xiangqi-3d-western.htm');
