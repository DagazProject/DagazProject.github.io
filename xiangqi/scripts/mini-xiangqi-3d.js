...
Dagaz.View.configure = function(view) {
    ...
    view.defPieceToken(2, 1, tokenPath, 'token.js', 'rChariot', 'Bump');
    view.defPieceToken(2, 2, tokenPath, 'token.js', 'bChariot', 'Bump');
    view.defPieceToken(3, 1, tokenPath, 'token.js', 'rCannon', 'Bump');
    view.defPieceToken(3, 2, tokenPath, 'token.js', 'bCannon', 'Bump');
    view.defPieceToken(4, 1, tokenPath, 'token.js', 'rMandarin', 'Bump');
    view.defPieceToken(4, 2, tokenPath, 'token.js', 'bMandarin', 'Bump');
    view.defPieceToken(5, 1, tokenPath, 'token.js', 'rGeneral', 'Bump');
    view.defPieceToken(5, 2, tokenPath, 'token.js', 'bGeneral', 'Bump');

    view.setCamera(0, 0, 0, -109, 215, 255);

    view.defControl("InfoControl", "Robert Price", true);
    view.defControl("ResControl", "3D", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'mini-xiangqi.htm' : 'mini-xiangqi-board.htm');
    view.defControl("UndoControl", "Undo Move", false, Dagaz.Controller.undo);
    view.defControl("NewControl", "New Game", true, Dagaz.Controller.newGame);
    view.defControl(Dagaz.AI.ON ? ["AiOnControl", "AiLightControl", "AiAlertControl"] : ["AiOffControl", "AiOffControl", "AiOffControl"], Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'mini-xiangqi-3d-board.htm' : 'mini-xiangqi-3d.htm');
