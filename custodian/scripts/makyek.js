...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.setup("Green", "Man", 40);
    design.setup("Green", "Man", 41);
    design.setup("Green", "Man", 42);
    design.setup("Green", "Man", 43);
    design.setup("Green", "Man", 44);
    design.setup("Green", "Man", 45);
    design.setup("Green", "Man", 46);
    design.setup("Green", "Man", 47);
    design.setup("Red", "Man", 16);
    design.setup("Red", "Man", 17);
    design.setup("Red", "Man", 18);
    design.setup("Red", "Man", 19);
