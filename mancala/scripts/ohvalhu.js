...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a2", 868, 8, 80, 80);
    view.defPosition("b2", 768, 8, 80, 80);
    view.defPosition("c2", 668, 8, 80, 80);
    view.defPosition("d2", 568, 8, 80, 80);
    view.defPosition("e2", 468, 8, 80, 80);
    view.defPosition("f2", 368, 8, 80, 80);
    view.defPosition("g2", 268, 8, 80, 80);
    view.defPosition("h2", 168, 8, 80, 80);
    view.defPosition("a1", 868, 108, 80, 80);
    view.defPosition("b1", 768, 108, 80, 80);
    view.defPosition("c1", 668, 108, 80, 80);
    view.defPosition("d1", 568, 108, 80, 80);
    view.defPosition("e1", 468, 108, 80, 80);
    view.defPosition("f1", 368, 108, 80, 80);
    view.defPosition("g1", 268, 108, 80, 80);
    view.defPosition("h1", 168, 108, 80, 80);
    view.defPosition("X1", 968, 8, 140, 180);
