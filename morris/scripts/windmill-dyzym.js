...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addMove(0, 4, [0, 0], 0);
    design.addMove(0, 4, [3, 3], 0);
    design.addMove(0, 4, [2, 2], 0);
    design.addMove(0, 4, [1, 1], 0);
    design.addMove(0, 4, [5, 5], 0);
    design.addMove(0, 4, [6, 6], 0);
    design.addMove(0, 4, [7, 7], 0);
    design.addMove(0, 4, [4, 4], 0);
