...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a5", -241, -287, 102, 102, 1);
    view.defPosition("b5", -109, -287, 102, 102, 1);
    view.defPosition("c5", 23, -287, 102, 102, 1);
    view.defPosition("d5", 155, -287, 102, 102, 1);
    view.defPosition("e5", 287, -287, 102, 102, 1);
    view.defPosition("a4", -241, -155, 102, 102, 1);
    view.defPosition("b4", -109, -155, 102, 102, 1);
    view.defPosition("c4", 23, -155, 102, 102, 1);
    view.defPosition("d4", 155, -155, 102, 102, 1);
    view.defPosition("e4", 287, -155, 102, 102, 1);
    view.defPosition("a3", -241, -23, 102, 102, 1);
    view.defPosition("b3", -109, -23, 102, 102, 1);
    view.defPosition("c3", 23, -23, 102, 102, 1);
    view.defPosition("d3", 155, -23, 102, 102, 1);
    view.defPosition("e3", 287, -23, 102, 102, 1);
    view.defPosition("a2", -241, 109, 102, 102, 1);
    view.defPosition("b2", -109, 109, 102, 102, 1);
    view.defPosition("c2", 23, 109, 102, 102, 1);
    view.defPosition("d2", 155, 109, 102, 102, 1);
    view.defPosition("e2", 287, 109, 102, 102, 1);
    view.defPosition("a1", -241, 241, 102, 102, 1);
    view.defPosition("b1", -109, 241, 102, 102, 1);
    view.defPosition("c1", 23, 241, 102, 102, 1);
    view.defPosition("d1", 155, 241, 102, 102, 1);
    view.defPosition("e1", 287, 241, 102, 102, 1);

    view.defPosition("A5", -884, -287, 102, 102, 1);
    view.defPosition("B5", -752, -287, 102, 102, 1);
    view.defPosition("C5", -596, -287, 102, 102, 1);
    view.defPosition("D5", -464, -287, 102, 102, 1);
    view.defPosition("E5", 462, -287, 102, 102, 1);
    view.defPosition("F5", 594, -287, 102, 102, 1);
    view.defPosition("G5", 750, -287, 102, 102, 1);
    view.defPosition("H5", 882, -287, 102, 102, 1);
    view.defPosition("A4", -884, -155, 102, 102, 1);
    view.defPosition("B4", -752, -155, 102, 102, 1);
    view.defPosition("C4", -596, -155, 102, 102, 1);
    view.defPosition("D4", -464, -155, 102, 102, 1);
    view.defPosition("E4", 462, -155, 102, 102, 1);
    view.defPosition("F4", 594, -155, 102, 102, 1);
    view.defPosition("G4", 750, -155, 102, 102, 1);
    view.defPosition("H4", 882, -155, 102, 102, 1);
    view.defPosition("A3", -884, -23, 102, 102, 1);
    view.defPosition("B3", -752, -23, 102, 102, 1);
    view.defPosition("C3", -596, -23, 102, 102, 1);
    view.defPosition("D3", -464, -23, 102, 102, 1);
    view.defPosition("E3", 462, -23, 102, 102, 1);
    view.defPosition("F3", 594, -23, 102, 102, 1);
    view.defPosition("G3", 750, -23, 102, 102, 1);
    view.defPosition("H3", 882, -23, 102, 102, 1);
    view.defPosition("A2", -884, 109, 102, 102, 1);
    view.defPosition("B2", -752, 109, 102, 102, 1);
    view.defPosition("C2", -596, 109, 102, 102, 1);
    view.defPosition("D2", -464, 109, 102, 102, 1);
    view.defPosition("E2", 462, 109, 102, 102, 1);
    view.defPosition("F2", 594, 109, 102, 102, 1);
    view.defPosition("G2", 750, 109, 102, 102, 1);
    view.defPosition("H2", 882, 109, 102, 102, 1);
    view.defPosition("A1", -884, 241, 102, 102, 1);
    view.defPosition("B1", -752, 241, 102, 102, 1);
    view.defPosition("C1", -596, 241, 102, 102, 1);
    view.defPosition("D1", -464, 241, 102, 102, 1);
    view.defPosition("E1", 462, 241, 102, 102, 1);
    view.defPosition("F1", 594, 241, 102, 102, 1);
    view.defPosition("G1", 750, 241, 102, 102, 1);
    view.defPosition("H1", 882, 241, 102, 102, 1);
}
