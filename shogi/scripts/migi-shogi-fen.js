...
var createPiece = function(design, c) {
  ...
  if (c == 'D') return Dagaz.Model.createPiece(design.getPieceType("Prince"), 1);
  if (c == 'd') return Dagaz.Model.createPiece(design.getPieceType("Prince"), 2);
...
var getPieceNotation = function(design, piece) {
  ...
  if (piece.type == design.getPieceType("Prince")) r = 'D';
