...
Dagaz.AI.WORKER_NAME  = 'scripts/ikusa-shogi-worker.js';
...
Dagaz.View.configure = function(view) {
    view.defBoard3D(142, 250, 1, -5, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "Board-1");
    view.defBoard3D(41,  158, 1, -5, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "Board-2",  1, -90, 0);
    view.defBoard3D(41,  158, 1, -5, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "Board-3",  1,  90, 0);
    view.defBoard3D(60,   56, 1, -5, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "Board-4",  1,   0, -150);
    view.defBoard3D(60,   56, 1, -5, [0xFFEDCB, 0xAC5146, 0xAC5146, 0xAC5146, 0xAC5146, 0xFFEDCB], "Board-5",  1,   0,  150);
    ...
    view.defControl("InfoControl", "2011 Yamamoto Mitsuo", true);
    view.defControl("UndoControl", "Undo Move", false, Dagaz.Controller.undo);
    view.defControl("NewControl", "New Game", true, Dagaz.Controller.newGame);
    view.defControl("ResControl", "3D", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'ikusa-shogi.htm' : 'ikusa-shogi-board.htm');
    view.defControl(Dagaz.AI.ON ? ["AiOnControl", "AiLightControl", "AiAlertControl"] : ["AiOffControl", "AiOffControl", "AiOffControl"], Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'ikusa-shogi-3d-board.htm' : 'ikusa-shogi-3d.htm');
