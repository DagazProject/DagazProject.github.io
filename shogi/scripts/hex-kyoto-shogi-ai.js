...
function DropMobility(piece, from) {
    ...
    if ((piece & Dagaz.AI.TYPE_MASK) == pieceLance) {
        if (color == Dagaz.AI.colorWhite) {
            to = from - 2; while (Dagaz.AI.g_board[to] == 0) { to -= 2; } if (Dagaz.AI.g_board[to] & enemy) mob++;
        } else {
            to = from + 2; while (Dagaz.AI.g_board[to] == 0) { to += 2; } if (Dagaz.AI.g_board[to] & enemy) mob++;
        }
    }
    ...
    if ((piece & Dagaz.AI.TYPE_MASK) == pieceBishop) {
        to = from - 32; while (Dagaz.AI.g_board[to] == 0) { to -= 32; } if (Dagaz.AI.g_board[to] & enemy) mob++;
        to = from + 32; while (Dagaz.AI.g_board[to] == 0) { to += 32; } if (Dagaz.AI.g_board[to] & enemy) mob++;
        to = from - 19; while (Dagaz.AI.g_board[to] == 0) { to -= 19; } if (Dagaz.AI.g_board[to] & enemy) mob++;
        to = from + 19; while (Dagaz.AI.g_board[to] == 0) { to += 19; } if (Dagaz.AI.g_board[to] & enemy) mob++;
        to = from - 13; while (Dagaz.AI.g_board[to] == 0) { to -= 13; } if (Dagaz.AI.g_board[to] & enemy) mob++;
        to = from + 13; while (Dagaz.AI.g_board[to] == 0) { to += 13; } if (Dagaz.AI.g_board[to] & enemy) mob++;
    }
