...
Dagaz.View.configure = function(view) {
    ...
    view.defPosition("a6", 77, 30, 102, 102);
    view.defPosition("b6", 209, 30, 102, 102);
    view.defPosition("c6", 341, 30, 102, 102);
    view.defPosition("d6", 473, 30, 102, 102);
    view.defPosition("e6", 605, 30, 102, 102);
    view.defPosition("a5", 77, 162, 102, 102);
    view.defPosition("b5", 209, 162, 102, 102);
    view.defPosition("c5", 341, 162, 102, 102);
    view.defPosition("d5", 473, 162, 102, 102);
    view.defPosition("e5", 605, 162, 102, 102);
    view.defPosition("a4", 77, 294, 102, 102);
    view.defPosition("b4", 209, 294, 102, 102);
    view.defPosition("c4", 341, 294, 102, 102);
    view.defPosition("d4", 473, 294, 102, 102);
    view.defPosition("e4", 605, 294, 102, 102);
    view.defPosition("a3", 77, 426, 102, 102);
    view.defPosition("b3", 209, 426, 102, 102);
    view.defPosition("c3", 341, 426, 102, 102);
    view.defPosition("d3", 473, 426, 102, 102);
    view.defPosition("e3", 605, 426, 102, 102);
    view.defPosition("a2", 77, 558, 102, 102);
    view.defPosition("b2", 209, 558, 102, 102);
    view.defPosition("c2", 341, 558, 102, 102);
    view.defPosition("d2", 473, 558, 102, 102);
    view.defPosition("e2", 605, 558, 102, 102);
    view.defPosition("a1", 77, 690, 102, 102);
    view.defPosition("b1", 209, 690, 102, 102);
    view.defPosition("c1", 341, 690, 102, 102);
    view.defPosition("d1", 473, 690, 102, 102);
    view.defPosition("e1", 605, 690, 102, 102);
}
