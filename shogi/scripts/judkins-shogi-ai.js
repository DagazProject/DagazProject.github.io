...
Dagaz.AI.ResetGame = function() {
  ...
  var pieceDeltas = [[], [], [], g_bishopDeltas, g_rookDeltas, g_rookDeltas, g_rookDeltas, g_rookDeltas, g_bishopDeltas, g_rookDeltas, g_kingDeltas, g_kingDeltas, g_kingDeltas];
  ...
  for (var row = 0; row < (Dagaz.Model.HEIGHT << 4); row += 0x10) {
      for (var col = 0; col < Dagaz.Model.WIDTH; col++) {
           ...
           g_vectorDelta[index].pieceMask[Dagaz.AI.colorWhite >> Dagaz.AI.TYPE_SIZE] |= (1 << piecePawn) | (1 << pieceSilver);
           ...
           g_vectorDelta[index].pieceMask[Dagaz.AI.colorWhite >> Dagaz.AI.TYPE_SIZE] |= (1 << pieceGold) | (1 << piecePawnP) | (1 << pieceSilverP) | (1 << pieceKnightP);
           index = square - (square - 15) + (Dagaz.AI.VECTORDELTA_SIZE >> 1);
           g_vectorDelta[index].pieceMask[Dagaz.AI.colorWhite >> Dagaz.AI.TYPE_SIZE] |= (1 << pieceGold) | (1 << piecePawnP) | (1 << pieceSilverP) | (1 << pieceKnightP);
           index = square - (square + 17) + (Dagaz.AI.VECTORDELTA_SIZE >> 1);
           g_vectorDelta[index].pieceMask[0] |= (1 << pieceGold) | (1 << piecePawnP) | (1 << pieceSilverP) | (1 << pieceKnightP);
           index = square - (square + 15) + (Dagaz.AI.VECTORDELTA_SIZE >> 1);
           g_vectorDelta[index].pieceMask[0] |= (1 << pieceGold) | (1 << piecePawnP) | (1 << pieceSilverP) | (1 << pieceKnightP);
...
function IsSquareAttackable(target, color) {
    ...
    gold = (color ? Dagaz.AI.colorWhite : Dagaz.AI.colorBlack) | piecePawnP;
    if (Dagaz.AI.g_board[target - (inc - 1)] == gold) return true;
    if (Dagaz.AI.g_board[target - (inc + 1)] == gold) return true;
    if (Dagaz.AI.g_board[target - 16] == gold) return true;
    if (Dagaz.AI.g_board[target + 16] == gold) return true;
    ...
    gold = (color ? Dagaz.AI.colorWhite : Dagaz.AI.colorBlack) | pieceSilverP;
    if (Dagaz.AI.g_board[target - (inc - 1)] == gold) return true;
    if (Dagaz.AI.g_board[target - (inc + 1)] == gold) return true;
    if (Dagaz.AI.g_board[target - 16] == gold) return true;
    if (Dagaz.AI.g_board[target + 16] == gold) return true;
    ...
    gold = (color ? Dagaz.AI.colorWhite : Dagaz.AI.colorBlack) | pieceKnightP;
    if (Dagaz.AI.g_board[target - (inc - 1)] == gold) return true;
    if (Dagaz.AI.g_board[target - (inc + 1)] == gold) return true;
    if (Dagaz.AI.g_board[target - 16] == gold) return true;
    if (Dagaz.AI.g_board[target + 16] == gold) return true;
...
function SeeAddSliderAttacks(target, us, attacks, pieceType) {
    ...
    if (_.indexOf([pieceGold, piecePawnP, pieceSilverP, pieceKnightP], pieceType) >= 0) {
        if (Dagaz.AI.g_board[target - (inc + 1)] == pieceType) attackerSq = target - (inc + 1);
        if (Dagaz.AI.g_board[target - (inc - 1)] == pieceType) attackerSq = target - (inc - 1);
    }
    if (_.indexOf([pieceKing, pieceGold, piecePawnP, pieceSilverP, pieceKnightP], pieceType) >= 0) {
