...
Dagaz.View.configure = function(view) {
    ...
    view.defControl("ResControl", "3D", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'hidari-shogi.htm' : 'hidari-shogi-board.htm');
    view.defControl(Dagaz.AI.ON ? "AiOnControl" : "AiOffControl", Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'hidari-shogi-3d-board.htm' : 'hidari-shogi-3d.htm');
    view.defControl(Dagaz.Controller.soundOff ? ["SoundOffControl", "SoundOnControl"] : ["SoundOnControl", "SoundOffControl"], "Sound", true, Dagaz.Controller.switchSound);
    view.defControl("RedoControl", "Redo Move", false, Dagaz.Controller.redo);

    view.defPosition("a6", -242, -352, 102, 102, 1);
    view.defPosition("b6", -110, -352, 102, 102, 1);
    view.defPosition("c6", 22, -352, 102, 102, 1);
    view.defPosition("d6", 154, -352, 102, 102, 1);
    view.defPosition("e6", 286, -352, 102, 102, 1);
    view.defPosition("a5", -242, -220, 102, 102, 1);
    view.defPosition("b5", -110, -220, 102, 102, 1);
    view.defPosition("c5", 22, -220, 102, 102, 1);
    view.defPosition("d5", 154, -220, 102, 102, 1);
    view.defPosition("e5", 286, -220, 102, 102, 1);
    view.defPosition("a4", -242, -88, 102, 102, 1);
    view.defPosition("b4", -110, -88, 102, 102, 1);
    view.defPosition("c4", 22, -88, 102, 102, 1);
    view.defPosition("d4", 154, -88, 102, 102, 1);
    view.defPosition("e4", 286, -88, 102, 102, 1);
    view.defPosition("a3", -242, 44, 102, 102, 1);
    view.defPosition("b3", -110, 44, 102, 102, 1);
    view.defPosition("c3", 22, 44, 102, 102, 1);
    view.defPosition("d3", 154, 44, 102, 102, 1);
    view.defPosition("e3", 286, 44, 102, 102, 1);
    view.defPosition("a2", -242, 176, 102, 102, 1);
    view.defPosition("b2", -110, 176, 102, 102, 1);
    view.defPosition("c2", 22, 176, 102, 102, 1);
    view.defPosition("d2", 154, 176, 102, 102, 1);
    view.defPosition("e2", 286, 176, 102, 102, 1);
    view.defPosition("a1", -242, 308, 102, 102, 1);
    view.defPosition("b1", -110, 308, 102, 102, 1);
    view.defPosition("c1", 22, 308, 102, 102, 1);
    view.defPosition("d1", 154, 308, 102, 102, 1);
    view.defPosition("e1", 286, 308, 102, 102, 1);

    view.defPosition("A6", -885, -352, 102, 102, 1);
    view.defPosition("B6", -753, -352, 102, 102, 1);
    view.defPosition("C6", -597, -352, 102, 102, 1);
    view.defPosition("D6", -465, -352, 102, 102, 1);
    view.defPosition("E6", 461, -352, 102, 102, 1);
    view.defPosition("F6", 593, -352, 102, 102, 1);
    view.defPosition("G6", 749, -352, 102, 102, 1);
    view.defPosition("H6", 881, -352, 102, 102, 1);
    view.defPosition("A5", -885, -220, 102, 102, 1);
    view.defPosition("B5", -753, -220, 102, 102, 1);
    view.defPosition("C5", -597, -220, 102, 102, 1);
    view.defPosition("D5", -465, -220, 102, 102, 1);
    view.defPosition("E5", 461, -220, 102, 102, 1);
    view.defPosition("F5", 593, -220, 102, 102, 1);
    view.defPosition("G5", 749, -220, 102, 102, 1);
    view.defPosition("H5", 881, -220, 102, 102, 1);
    view.defPosition("A4", -885, -88, 102, 102, 1);
    view.defPosition("B4", -753, -88, 102, 102, 1);
    view.defPosition("C4", -597, -88, 102, 102, 1);
    view.defPosition("D4", -465, -88, 102, 102, 1);
    view.defPosition("E4", 461, -88, 102, 102, 1);
    view.defPosition("F4", 593, -88, 102, 102, 1);
    view.defPosition("G4", 749, -88, 102, 102, 1);
    view.defPosition("H4", 881, -88, 102, 102, 1);
    view.defPosition("A3", -885, 44, 102, 102, 1);
    view.defPosition("B3", -753, 44, 102, 102, 1);
    view.defPosition("C3", -597, 44, 102, 102, 1);
    view.defPosition("D3", -465, 44, 102, 102, 1);
    view.defPosition("E3", 461, 44, 102, 102, 1);
    view.defPosition("F3", 593, 44, 102, 102, 1);
    view.defPosition("G3", 749, 44, 102, 102, 1);
    view.defPosition("H3", 881, 44, 102, 102, 1);
    view.defPosition("A2", -885, 176, 102, 102, 1);
    view.defPosition("B2", -753, 176, 102, 102, 1);
    view.defPosition("C2", -597, 176, 102, 102, 1);
    view.defPosition("D2", -465, 176, 102, 102, 1);
    view.defPosition("E2", 461, 176, 102, 102, 1);
    view.defPosition("F2", 593, 176, 102, 102, 1);
    view.defPosition("G2", 749, 176, 102, 102, 1);
    view.defPosition("H2", 881, 176, 102, 102, 1);
    view.defPosition("A1", -885, 308, 102, 102, 1);
    view.defPosition("B1", -753, 308, 102, 102, 1);
    view.defPosition("C1", -597, 308, 102, 102, 1);
    view.defPosition("D1", -465, 308, 102, 102, 1);
    view.defPosition("E1", 461, 308, 102, 102, 1);
    view.defPosition("F1", 593, 308, 102, 102, 1);
    view.defPosition("G1", 749, 308, 102, 102, 1);
    view.defPosition("H1", 881, 308, 102, 102, 1);
}
