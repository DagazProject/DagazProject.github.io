...
Dagaz.Model.checkVersion = function(design, name, value) {
  if (name != "judkins-shogi-invariant") {
...
var isKnightAttacked = function(design, board, player, pos, o, d, type) {
...
Dagaz.Model.CheckInvariants = function(board) {
  ...
  var np     = design.getPieceType("KnightP");
  ...
  _.each(board.moves, function(m) {
      ...
      if (isAttacked(design, b, board.player, pos, n, [king, gold, silver, sp, bp, pawn, pp, np], [rook, rp]) ||
          isAttacked(design, b, board.player, pos, s, [king, gold, sp, bp, pp, np], [rook, rp]) ||
          isAttacked(design, b, board.player, pos, w, [king, gold, sp, bp, pp, np], [rook, rp]) ||
          isAttacked(design, b, board.player, pos, e, [king, gold, sp, bp, pp, np], [rook, rp]) ||
          isAttacked(design, b, board.player, pos, nw, [king, gold, silver, sp, rp, pp, np], [bishop, bp]) ||
          isAttacked(design, b, board.player, pos, ne, [king, gold, silver, sp, rp, pp, np], [bishop, bp]) ||
          ...
          isKnightAttacked(design, b, board.player, pos, n, nw, knight) ||
      ...
      if (m.isSimpleMove()) {
          ...
          var piece = board.getPiece(pos);
          if ((piece !== null) && (_.indexOf([pawn, knight], +piece.type) >= 0) && !design.inZone(0, board.player, pos)) {
               pos = m.actions[0][1][0];
