...
Dagaz.AI.WORKER_NAME  = 'scripts/treasure-shogi-worker.js';
...
Dagaz.View.configure = function(view) {
    ...
    view.defControl("InfoControl", "2010 Yamamoto Mitsuo", true);
    view.defControl("UndoControl", "Undo Move", false, Dagaz.Controller.undo);
    view.defControl("NewControl", "New Game", true, Dagaz.Controller.newGame);
    view.defControl("ResControl", "3D", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'treasure-shogi.htm' : 'treasure-shogi-board.htm');
    view.defControl(Dagaz.AI.ON ? ["AiOnControl", "AiLightControl", "AiAlertControl"] : ["AiOffControl", "AiOffControl", "AiOffControl"], Dagaz.AI.ON ? "AI" : "No AI", true, Dagaz.Controller.go, Dagaz.AI.ON ? 'treasure-shogi-3d-board.htm' : 'treasure-shogi-3d.htm');
