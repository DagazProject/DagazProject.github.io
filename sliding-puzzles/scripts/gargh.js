...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPiece("R0101FC", 26);
    design.addAttribute(26, 0, 12);
    design.addAttribute(26, 1, 'R0101F');
    design.addMove(26, 0, [3], 0);
    design.addMove(26, 0, [2], 0);
    design.addMove(26, 0, [0], 0);
    design.addMove(26, 0, [1], 0);

    design.addPiece("R1001FC", 27);
    design.addAttribute(27, 0, 12);
    design.addAttribute(27, 1, 'R1001F');
    design.addMove(27, 0, [3], 0);
    design.addMove(27, 0, [2], 0);
    design.addMove(27, 0, [0], 0);
    design.addMove(27, 0, [1], 0);

    design.setup("You", "B0110F1", 0);
    design.setup("You", "B1010F1", 1);
    design.setup("You", "B0100F2", 2);
    design.setup("You", "B1000F2", 3);
    design.setup("You", "B0010F3", 4);
    design.setup("You", "B0010F4", 5);

    design.setup("You", "B0101F1", 6);
    design.setup("You", "B1001F1", 7);
    design.setup("You", "B0100F5", 8);
    design.setup("You", "B1000F5", 9);
    design.setup("You", "B0001F3", 10);
    design.setup("You", "B0001F4", 11);

    design.setup("You", "B0100F6", 12);
    design.setup("You", "B1000F6", 13);
    design.setup("You", "B0000F7", 14);
    design.setup("You", "B0000F8", 15);

    design.setup("You", "B0010F9", 18);
    design.setup("You", "B0010FA", 19);
    design.setup("You", "B0100FB", 20);
    design.setup("You", "B1000FB", 21);
    design.setup("You", "R0110FC", 22);
    design.setup("You", "R1010FC", 23);

    design.setup("You", "B0001F9", 24);
    design.setup("You", "B0001FA", 25);
    design.setup("You", "B0100FD", 26);
    design.setup("You", "B1000FD", 27);
    design.setup("You", "R0101FC", 28);
    design.setup("You", "R1001FC", 29);

    design.goal(0, "You", "R0110FC", [18]);
    design.goal(0, "You", "R1010FC", [19]);
    design.goal(0, "You", "R0101FC", [24]);
    design.goal(0, "You", "R1001FC", [25]);
}

Dagaz.View.configure = function(view) {
    view.defPiece("YouB0110F1", "You B0110F1");
    view.defPiece("YouB1010F1", "You B1010F1");
    view.defPiece("YouB0100F2", "You B0100F2");
    view.defPiece("YouB1000F2", "You B1000F2");
    view.defPiece("YouB0010F3", "You B0010F3");
    view.defPiece("YouB0010F4", "You B0010F4");
    view.defPiece("YouB0101F1", "You B0101F1");
    view.defPiece("YouB1001F1", "You B1001F1");
    view.defPiece("YouB0100F5", "You B0100F5");
    view.defPiece("YouB1000F5", "You B1000F5");
    view.defPiece("YouB0001F3", "You B0001F3");
    view.defPiece("YouB0001F4", "You B0001F4");
    view.defPiece("YouB0100F6", "You B0100F6");
    view.defPiece("YouB1000F6", "You B1000F6");
    view.defPiece("YouB0000F7", "You B0000F7");
    view.defPiece("YouB0000F8", "You B0000F8");
    view.defPiece("YouB0010F9", "You B0010F9");
    view.defPiece("YouB0010FA", "You B0010FA");
    view.defPiece("YouB0100FB", "You B0100FB");
    view.defPiece("YouB1000FB", "You B1000FB");
    view.defPiece("YouR0110FC", "You R0110FC");
    view.defPiece("YouR1010FC", "You R1010FC");
    view.defPiece("YouB0001F9", "You B0001F9");
    view.defPiece("YouB0001FA", "You B0001FA");
    view.defPiece("YouB0100FD", "You B0100FD");
    view.defPiece("YouB1000FD", "You B1000FD");
    view.defPiece("YouR0101FC", "You R0101FC");
    view.defPiece("YouR1001FC", "You R1001FC");
