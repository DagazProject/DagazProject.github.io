...
Dagaz.Model.BuildDesign = function(design) {
    ...
    design.addPiece("B1010FC", 21);
    design.addAttribute(21, 0, 12);
    design.addAttribute(21, 1, 'B1010F');
    ...
    design.setup("You", "B0110FC", 22);
    design.setup("You", "B1010FC", 23);
    design.setup("You", "B0001F9", 24);
    design.setup("You", "B0001FA", 25);
    design.setup("You", "B0100FD", 26);
    design.setup("You", "B1000FD", 27);
    design.setup("You", "B0101FC", 28);
    design.setup("You", "B1001FC", 29);

    design.goal(0, "You", "R0110F1", [18]);
    design.goal(0, "You", "R1010F1", [19]);
    design.goal(0, "You", "R0101F1", [24]);
    design.goal(0, "You", "R1001F1", [25]);
}
...
Dagaz.View.configure = function(view) {
    ...
    view.defPiece("YouB0110FC", "You B0110FC");
    view.defPiece("YouB1010FC", "You B1010FC");
    ...
    view.defPiece("YouB0101FC", "You B0101FC");
    view.defPiece("YouB1001FC", "You B1001FC");
